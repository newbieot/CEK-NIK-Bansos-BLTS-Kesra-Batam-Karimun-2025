...
with col_judul:
    # --- PERBAIKAN DI SINI (HTML DIRAPIKAN) ---
    # Kita gunakan satu blok st.markdown dengan unsafe_allow_html=True
    # Pastikan teks HTML mepet kiri (tanpa spasi di awal baris kutip) agar tidak dianggap code block
    st.markdown("""
